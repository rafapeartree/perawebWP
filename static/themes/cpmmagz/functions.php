...
if (!  function_exists('cpmmagz_scripts') ) {
	function cpmmagz_scripts() {
		...
		// Add Font awesome via https://cdn.fontawesome.com/
		wp_enqueue_script( 'fontawesome-js', '//use.fontawesome.com/238899eb9b.js', array('jquery'), true );
		wp_enqueue_script( 'cpmmagz-vendor-js', get_template_directory_uri(). '/assets/js/vendor.min.js', array(), true );
		wp_enqueue_script( 'cpmmagz-app-js',  get_template_directory_uri() . '/assets/js/app.min.js', array(), true );

		// IE conditional statements
		wp_enqueue_script( 'cpmmagz-html5shiv', '//oss.maxcdn.com/html5shiv/3.7.2/html5shiv.min.js', array(), '', false);
		wp_script_add_data( 'cpmmagz-html5shiv', 'conditional', 'lt IE 9' );

		wp_enqueue_script( 'cpmmagz-respond', '//oss.maxcdn.com/respond/1.4.2/respond.min.js', array(), '', false);
