...
if (! function_exists('cpmmagz_meta_data')) {
    function cpmmagz_meta_data($post){
        ...
        <ul >
            ...
            <li><a href = "<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>"><i class="fa fa-user"></i>By <?php echo esc_attr( get_the_author_meta('display_name',$post->post_author) ); ?></a></li>
...
if (! function_exists('cpmmagz_social_icons')) {
    function cpmmagz_social_icons()
    {
        ...
        $googleplus_link = get_theme_mod('google+_link');
        $tumblr_link = get_theme_mod('tumblr_link');
        $wordpress_link = get_theme_mod('wordpress_link');
        $dribble_link = get_theme_mod('dribble_link');
        if( $facebook_link || $twitter_link || $youtube_link || $instagram_link || $linkedin_link || $pinterest_link || $googleplus_link || $tumblr_link)  { ?>
